...
qld_df = pd.DataFrame(data, columns=columns)
...
# Create a map centered around QLD, Australia
m = folium.Map(location=[-22.57, 144.54], zoom_start=7)
...
for index, row in qld_df.iterrows():
...
<div style="position: fixed; bottom: 50px; right: 50px; z-index: 1000; background-color: transparent; border: 2px solid black; padding: 3px; max-height: 200px; overflow-y: auto;">
     ...
     <p><i class="fa fa-circle fa-lg" style="color:green"></i> Palms</p>
     <p><i class="fa fa-circle fa-lg" style="color:red"></i> Cycads</p>
     <p><i class="fa fa-circle fa-lg" style="color:purple"></i> Fruit</p>
     <p><i class="fa fa-circle fa-lg" style="color:pink"></i> Tree</p>
     <p><i class="fa fa-circle fa-lg" style="color:gray"></i> Small Tree</p>
     <p><i class="fa fa-circle fa-lg" style="color:brown"></i> Medium Tree</p>
</div>
'''
m.get_root().html.add_child(folium.Element(legend_html))

# Save the map as an HTML file
map_file = "/var/www/html/wordpress/wp-content/themes/QLD_plants_map.html" 
m.save(map_file)
